...
Ejemplos:
  ...
  node post.js "Hoy oferta especial!" "assets/IMAGENES/chilaquiles_verdes.png"
  node post.js "Texto" "ruta/imagen.png"  (Facebook + Instagram)
  node post.js "Texto" "ruta/imagen.png" --ig-only
  node post.js "Texto" "ruta/imagen.png" --fb-only
    `)
    process.exit(0)
  }
